...
import redisco
from redisco.containerstests import (SetTestCase, ListTestCase,
                                     TypedListTestCase,
                                     SortedSetTestCase, HashTestCase)
from redisco.models.basetests import (ModelTestCase, DateFieldTestCase,
                                      FloatFieldTestCase,
                                      BooleanFieldTestCase, ListFieldTestCase,
                                      ReferenceFieldTestCase,
                                      TimeDeltaFieldTestCase,
                                      DateTimeFieldTestCase,
                                      CounterFieldTestCase,
...
typed_list_suite = unittest.TestLoader().loadTestsFromTestCase(
    TypedListTestCase)
